        ...
        <div className={styles.head}>
          ...
          <div className={styles.contact}>
            <div className={styles.socialGroup}>
              <a target="_blank" rel="noopener noreferrer" href="https://hendra-foo.github.io/" className={styles.social}>
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/hendra-foo-a86226144" className={styles.social}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
              </a>
            </div>
            <a target="_blank" rel="noopener noreferrer" href="mailto:fu.ceyong18@gmail.com" className={styles.email}>fu.ceyong18@gmail.com</a>
          </div>
        </div>
          ...
          <div className={styles.content}>
            <Group title="Experience">
              <Experience
                ...
                location="Jakarta, ID"
                desc="Build Project Management System application and do minor Cloud Architecting"
              />
              <Experience
            ...
            <Group title="Skills">
              <Skill
                ...
                desc={<>
                  ...
                  <br />
                  <small>Stacks: React.js, Next.js, Vue.js, Bootstrap + Sass, Laravel, Bitbucket</small>
                </>}
              />
              <Skill
                name="UI/UX Design"
                desc="Adobe XD, Figma, Photoshop"
              />
            </Group>
          </div>
        </div>
...
const Certification = ({ name, date, issuer, url }) => {
  return (
    <div className={styles.certificationRoot}>
      <h5 className={styles.name}>{name}</h5>
      <div className={styles.issuer}>{issuer}</div>
      <div className={styles.date}>{date}</div>
      <a target="_blank" rel="noopener noreferrer" href={url} className={styles.credential}>See credential</a>
    </div>
  )
}
